...
using WatchShop.Areas.Administrator.Models;
namespace WatchShop.Areas.Administrator
{
    public class AdminDB
    {
        public static string cn = @"Data Source=DESKTOP-UJ22PI5;initial catalog=WatchShop;Integrated Security=True";
